...
echo "\nBita-K8s: \e[1;36mCongrats - You successfully fixed $issue_env\e[0m \n " >$indexfile
#echo "Bita-K8s: Congrats - You fixed Issue number 3 \n " >/data/index3.html
#echo "Bita-K8s: Awesome - You fixed Issue number 4 \n " >/data/index4.html
...
metadata:
  ...
  namespace: $namespace
data:
  index5err.html: "Bita-K8s: Congrats - You are moving ahead and successfully
    fixed $issue_env \n \n"
EOF
